  ...
  products : [
    {
      ...
      detailsUrl: '/program',
      type: 'bootcamp' }, { topic: 'JavaScript Best Practices and Patterns', date: 'On demand', length: 'Half Day Workshop', detailsUrl: '/workshops/javascript-best-practices-and-patterns', type: 'workshop' }, { topic: 'Writing Testable JavaScript Application', date: 'On demand', length: 'Half Day Workshop', detailsUrl: '/workshops/writing-testable-javascript-applications', type: 'workshop'
      },
      {
        topic: 'Getting up and running with ES6',
        date: 'On demand',
